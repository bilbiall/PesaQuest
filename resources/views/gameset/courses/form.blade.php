    ...
    <form method="POST" action="{{ $mode === 'create' ? route('gameset.courses.store') : route('gameset.courses.update', $course) }}">
        ...
        <div class="form-section">
            ...
            <div class="flex flex-col gap-4">
                <div>
                    <label class="form-label">Short Description * <span class="font-normal normal-case text-white/30">(shown on card, max 500 chars)</span></label>
                ...
                <div>
                    <label class="form-label">Full Course Content <span class="font-normal normal-case text-white/30">(shown in detail modal — plain text or bullet points)</span></label>
                ...
                <div>
                    <label class="form-label">Learning Outcome * <span class="font-normal normal-case text-white/30">(what skill/badge is unlocked)</span></label>
                ...
                <div>
                    <label class="form-label">Jobs Intro <span class="font-normal normal-case text-white/30">(shown in completion popup — what doors this opens, max 300 chars)</span></label>
                ...
                <div>
                    <label class="form-label">Financial Education Tip <span class="font-normal normal-case text-white/30">(shown in completion popup — specific to this course's career path)</span></label>
        ...
        <div class="form-section">
            ...
            <div class="flex items-center gap-6 mt-4">
                <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="text-sm font-bold text-white/70">Free course</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
