...
<head>
    ...
    <title>PesaQuest – Life Board</title>
    ...
    <style>
        ...
        /* ── Asset card variants (category-coloured) ── */
        ...
        .toast-wrap {
            backdrop-filter: blur(12px);
            animation: slideIn .4s ease, fadeOut .5s ease 2.5s forwards;
        }
        @keyframes slideIn { from { transform: translateX(120%); opacity:0; } to { transform: translateX(0); opacity:1; } }
        @keyframes fadeOut { to { opacity:0; transform: translateX(120%); } }

        /* ── Milestone progress bar shimmer ── */
        .milestone-bar {
...
<body class="life-bg min-h-screen text-white font-sans antialiased" x-data="lifeBoard()">
    ...
    {{-- ── NAV ── --}}
    <x-life-topnav active="board" title="Life HQ" icon="🌍" />
