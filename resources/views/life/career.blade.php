...
<head>
    ...
    <style>
        ...
        .nav-pill {
            ...
            border-radius: .5rem; border: 1px solid; transition: all .2s;
        }
    </style>
</head>
<body class="career-bg min-h-screen text-white font-sans antialiased">

    {{-- NAV --}}
    <x-life-topnav active="career" title="Career" icon="💼" />
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div class="grid lg:grid-cols-5 gap-5">
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <div class="glass rounded-2xl p-5">
                    <h3 class="text-sm font-bold text-white mb-3">🗂 Career Fields</h3>
                    <div class="space-y-2">
            ...
            <div class="lg:col-span-3 space-y-4">
                ...
                {{-- Payslip tips --}}
                <div class="glass rounded-2xl p-5">
                    <h3 class="text-sm font-bold text-white mb-3">💡 Maximise Your Take-Home</h3>
                    <div class="space-y-3">
                ...
                <div class="glass rounded-2xl p-5">
                    <h3 class="text-sm font-bold text-white mb-3">📅 Recent Paydays</h3>
                    <div class="space-y-2">
        ...
        <div class="mt-5 grid sm:grid-cols-2 gap-4">
            ...
            <div class="glass rounded-2xl overflow-hidden">
                <div class="px-5 py-4 border-b border-white/5 flex items-center justify-between"
                    ...
                    <a href="{{ route('opportunities.index') }}"
                       class="text-xs font-bold px-3 py-1.5 rounded-xl text-emerald-300 hover:text-white transition-colors"
        ...
        <div class="mt-8 pt-6 border-t border-white/5 flex flex-wrap gap-2 justify-center pb-8">
            @foreach([
                ['route' => 'life.board',      'label' => '🏠 Life Board'],
                ['route' => 'life.timeline',   'label' => '📜 Timeline'],
